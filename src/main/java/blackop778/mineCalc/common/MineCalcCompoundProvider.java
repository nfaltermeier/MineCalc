...
public class MineCalcCompoundProvider implements ICapabilitySerializable<NBTBase> {
	...
	return capability == MCC_CAP ? (T) getInstance() : null;
    }

    @Override
    public NBTBase serializeNBT() {
	return MCC_CAP.getStorage().writeNBT(MCC_CAP, getInstance(), null);
    }

    @Override
    public void deserializeNBT(NBTBase nbt) {
	MCC_CAP.getStorage().readNBT(MCC_CAP, getInstance(), null, nbt);
    }
